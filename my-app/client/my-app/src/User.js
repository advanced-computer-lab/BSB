    ...
    return (
        <div>
            ...
            {/* <ChooseSeat logout={logoutClicked} edit={editProfile} />  */}
                ...
                {searchClicked ? <ChooseSeat/> : (editProfile ? <EditProfile logout={logoutClicked} back={backButton} component={<User />} /> : (logoutClicked || backButton ? <App /> : (viewResFlights ? <ViewResFlights edit={editProfile} logout={logoutClicked} back={backButton} component={<User />} /> :
